defmodule GothamcityWeb.WorkingtimeControllerTest do
  ...
  @update_attrs %{
    end: ~U[2022-10-25 11:14:00Z],
    start: ~U[2022-10-25 11:14:00Z]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2022-10-24T11:14:00Z",
               "start" => "2022-10-24T11:14:00Z"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2022-10-25T11:14:00Z",
               "start" => "2022-10-25T11:14:00Z"
             } = json_response(conn, 200)["data"]
    end
