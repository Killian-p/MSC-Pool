defmodule GothamWeb.ClockControllerTest do
  ...
  #     conn = post(conn, Routes.clock_path(conn, :create), clock: %{status: true, time: ~U[2022-10-24 11:47:00Z], user: user.id})
