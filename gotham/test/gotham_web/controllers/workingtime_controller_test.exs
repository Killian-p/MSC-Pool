defmodule GothamWeb.WorkingtimeControllerTest do
  ...
  @update_attrs %{
    end: ~U[2022-10-25 11:47:00Z],
    start: ~U[2022-10-25 11:47:00Z]
  }
  ...
  #     assert %{
  #              "id" => ^id,
  #              "end" => "2022-10-24T11:47:00Z",
  #              "start" => "2022-10-24T11:47:00Z"
  ...
  #     assert %{
  #              "id" => ^id,
  #              "end" => "2022-10-25T11:47:00Z",
  #              "start" => "2022-10-25T11:47:00Z"
  #            } = json_response(conn, 200)["data"]
  #   end
